...
request(options, (err, res) => {
  ...
  if (tacReg.test(content)) {
    tacContent = RegExp.$1
    console.log('tacContent', tacContent)
    tacContent = tacContent.replace(/`/g, '\\`')

    const dom = new JSDOM(`
    <body></body>
    <script>tac${tacContent}</script>
