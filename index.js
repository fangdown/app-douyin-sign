...
async function task(uid = '59220068103') {
  let tac = await require('./tac')()
  global.tac = tac
  // global.tac = tac2
  // console.log('global.tac', global.tac)
  console.log(tac)
  // console.log(tac2)
